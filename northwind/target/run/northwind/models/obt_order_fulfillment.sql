...
create or replace transient table analytics.dbt_mwoods_northwind.obt_order_fulfillment
    
    as (with f_order_fulfillment as (
    select * from analytics.dbt_mwoods_northwind.fact_order_fulfillment
),
d_customer as (
